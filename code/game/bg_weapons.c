...
weaponData_t weaponData_1_02[WP_NUM_WEAPONS] = 
{
	{	// WP_NONE
...
weaponData_t weaponData_1_03[WP_NUM_WEAPONS] = 
{
	{	// WP_NONE
//		"No Weapon",			//	char	classname[32];		// Spawning name
		AMMO_NONE,				//	int		ammoIndex;			// Index to proper ammo slot
...
weaponData_t weaponData_1_04[WP_NUM_WEAPONS] = 
{
	{	// WP_NONE
//		"No Weapon",			//	char	classname[32];		// Spawning name
		AMMO_NONE,				//	int		ammoIndex;			// Index to proper ammo slot
...
weaponData_t *weaponData = weaponData_1_04;
